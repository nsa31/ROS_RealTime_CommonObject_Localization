...
while True:
	...
	for i in np.arange(0, detections.shape[2]):
		...
		if confidence > 0.2 : #args["confidence"]:
			...
			sendData(sock, str(idx))
			sendData(sock, str(startX))
			sendData(sock, str(startY))
			sendData(sock, str(endX))
			sendData(sock, str(endY))
